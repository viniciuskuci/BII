...
def execute_simulation(system, args):
    system.simulate(simulation_time=args.simulation_time, verbose=False) #1440 minutes = 1 day
    return args.simulation_time / sum(sink.level for sink in system.sinks) #returns the throughput time

if __name__ == '__main__':
    print('Throughput time: ', execute_simulation(system, args))
